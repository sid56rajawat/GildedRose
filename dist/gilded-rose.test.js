...
describe('Tests for Ordinary Items', () => {
...
describe('Tests for Backstage passes to a TAFKAL80ETC concert', () => {
...
describe('Test for Sulfuras, Hand of Ragnaros', () => {
    test('Sulfarus does not change at all', () => {
        const gildedRose = new gilded_rose_1.GildedRose([
            new gilded_rose_1.Item('Sulfuras, Hand of Ragnaros', 4, 80)
        ]);
        let items = gildedRose.updateQuality();
...
describe('General Tests for all item types', () => {
    test('For All Items Quality does not go below 0', () => {
        const gildedRose = new gilded_rose_1.GildedRose([
            new gilded_rose_1.Item('banana', 5, 0),
            new gilded_rose_1.Item('Aged Brie', 5, 0),
            new gilded_rose_1.Item('Backstage passes to a TAFKAL80ETC concert', 5, 0),
            new gilded_rose_1.Item('Sulfuras, Hand of Ragnaros', 4, 80),
        ]);
        let items = gildedRose.updateQuality();
    ...
    test('For All Items Quality does not go above 50 except Sulfuras', () => {
        const gildedRose = new gilded_rose_1.GildedRose([
            new gilded_rose_1.Item('banana', 5, 50),
            new gilded_rose_1.Item('Aged Brie', 5, 50),
            new gilded_rose_1.Item('Backstage passes to a TAFKAL80ETC concert', 5, 50),
        ]);
        let items = gildedRose.updateQuality();
        for (const item of items) {
